...
Its approach originated when working with temporal data that are not exactly defined but comes with lower (and upper) bounds, also called [terminus ante (and post) quem](https://en.wikipedia.org/wiki/Terminus_post_quem). 

pataqu can also be used when dating comes with a confidence interval likely to affect interpretation, for instance [radiocarbon dating](https://en.wikipedia.org/wiki/Radiocarbon_dating),
